...
import com.alphacircle.vroadway.data.room.VroadwayDatabase
...
object Graph {
    ...
    lateinit var database: VroadwayDatabase
        private set
    ...
    fun provide(context: Context) {
        ...
        database = Room.databaseBuilder(context, VroadwayDatabase::class.java, "data.db")
